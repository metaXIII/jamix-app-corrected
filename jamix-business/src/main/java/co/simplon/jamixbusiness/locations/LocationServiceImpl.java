...
public class LocationServiceImpl implements LocationService {
  ...
  public Boolean isReal(LocationViewDto locationDto) {
    ...
    String url = jamixConfig.apiConfig().geo() + "?codePostal=" + zipCode;
    ...
    try {
      ...
      log.severe("API validation failed: " + e.getMessage());
      return false;
    }
  }
  ...
  public LocationViewDto create(LocationCreateDto dto) {
    ...
    if (Boolean.FALSE.equals(isReal(locationDto))) {
